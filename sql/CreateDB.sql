create table customer (customerID char(9) not null, name varchar(35) not null, age int4 not null, roomNum int4 not null, phone char(10) not null, primary key (customerID));
